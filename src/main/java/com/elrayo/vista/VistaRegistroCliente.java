...
public class VistaRegistroCliente extends javax.swing.JDialog {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtDni, javax.swing.GroupLayout.DEFAULT_SIZE, 324, Short.MAX_VALUE)
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Mostar Datos"));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String dniBuscar = JOptionPane.showInputDialog(this, "🔍 Ingresa el DNI del Cliente a buscar:");
        ...
        for (int i = 0; i < tbCliente.getRowCount(); i++) {
            String dniTabla = tbCliente.getValueAt(i, 2).toString();
        ...
        if (filaEncontrada != -1) {
            tbCliente.setRowSelectionInterval(filaEncontrada, filaEncontrada);
            tbCliente.scrollRectToVisible(tbCliente.getCellRect(filaEncontrada, 0, true));
        } else {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        String nombre = tbCliente.getValueAt(fila, 0).toString();
        String dni = tbCliente.getValueAt(fila, 1).toString();
        String telefono = tbCliente.getValueAt(fila, 2).toString();
        String direccion = tbCliente.getValueAt(fila, 3).toString();
