...
public class Desing extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Desing.class.getName());
    ...
    private void initComponents() {
        ...
        btn_lends.setIcon(new javax.swing.ImageIcon(getClass().getResource("/account-multiple.png"))); // NOI18N
        btn_lends.setText("Clientes");
        ...
        btn_returns.setIcon(new javax.swing.ImageIcon(getClass().getResource("/food-delivery-man-motorcycle-white-icon.png"))); // NOI18N
        btn_returns.setText("Motorizados");
        ...
        btn_users.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cutlery.png"))); // NOI18N
        btn_users.setText("Restaurant");
        btn_users.setActionCommand("Restaurantes");
        ...
        btn_books.setIcon(new javax.swing.ImageIcon(getClass().getResource("/to-do-list.png"))); // NOI18N
        btn_books.setText("Pedidos");
        ...
        btn_reports.setIcon(new javax.swing.ImageIcon(getClass().getResource("/chart.png"))); // NOI18N
        ...
        btn_reports1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/file-chart.png"))); // NOI18N
        btn_reports1.setText("Cierres");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Desing().setVisible(true));
    }
