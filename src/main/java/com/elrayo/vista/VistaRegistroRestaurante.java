...
public class VistaRegistroRestaurante extends javax.swing.JDialog {

    private VistaGestionRestaurante padre;

    public VistaRegistroRestaurante(java.awt.Frame parent, boolean modal) {
        super(parent, true);
        initComponents();
        setLocationRelativeTo(parent);

        if (parent instanceof VistaGestionRestaurante) {
            this.padre = (VistaGestionRestaurante) parent;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Restaurante nuevo = new Restaurante(nombre, telefono, direccion, tieneConvenio);
        ControladorRestaurante controlador = new ControladorRestaurante();
        if (controlador.registrarRestaurante(nuevo)) {
            JOptionPane.showMessageDialog(this, "✅ Restaurante registrado correctamente.");
...
*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaRegistroRestaurante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VistaRegistroRestaurante dialog = new VistaRegistroRestaurante(new javax.swing.JFrame(), true);
